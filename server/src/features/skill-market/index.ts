...
export const skillMarketRoutes = new Elysia()
  ...
  .group('/skills/market', (app) =>
    app
      ...
      .get('/:id', ({ params }) => skillMarketService.getMarketSkill(params.id), {
        params: z.object({
          id: z.uuid(),
        }),
      }),
  ...
  .group('/projects/:projectId/skills', (app) =>
    app
      ...
      .get('/name-available', ({ params, query }) => {
        return skillMarketService.isSkillNameAvailable(params.projectId, query.name)
      }, {
        query: nameAvailableQuerySchema,
      })
      .post('/install', ({ params, body }) => {
