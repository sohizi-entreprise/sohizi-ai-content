...
import type { BillingReservation, Credits, ReserveInput, SettleInput } from './types'
...
export class BillingService {
   ...
   */
  async extend(reservationId: string, ttlMs: number): Promise<BillingReservation> {
  ...
  async getReservation(reservationId: string): Promise<BillingReservation | null> {
