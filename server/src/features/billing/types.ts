import type { BillingReservation, BillingLedgerEntry, BillingReservationStatus, BillingLedgerKind } from '@/db/schema'

export type { BillingReservation, BillingLedgerEntry, BillingReservationStatus, BillingLedgerKind }
...
export interface BillableStream<TInput, TChunk> {
  ...
  ttlMs?: number
  estimateCost(input: TInput): Credits | Promise<Credits>
  stream(input: TInput, signal: AbortSignal): AsyncGenerator<TChunk, void, unknown>
  /**
