...
export const stopEvaluationSchema = z.object({
    ...
    instruction: z.string().describe('When isDone is false, provide a concise instruction telling the agent to proceed with the action it described. When isDone is true, this can be empty.'),
});
