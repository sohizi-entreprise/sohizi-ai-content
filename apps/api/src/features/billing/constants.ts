...
export const TOKEN_OVERHEAD_RATE = 0.2 // 20% overhead rate
export const IMAGE_OVERHEAD_RATE = 0.25 // 25% overhead rate
export const AUDIO_OVERHEAD_RATE = 0.25 // 25% overhead rate
export const VIDEO_OVERHEAD_RATE = 0.3 // 30% overhead rate
export const TOPUP_TARGET_MARGIN = 0.7 // 70% target margin
