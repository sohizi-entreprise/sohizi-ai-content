...
const submitHtmlCompositionDoneSchema = z.object({
  ...
  name: z
    ...
    .max(200)
    .optional()
    .describe("Short display name for the asset"),
  duration: z
    .number()
    .positive()
    .max(600)
  ...
  width: z
    ...
    .max(7680)
    .optional()
    .describe("Composition width in pixels. Default 1920."),
  height: z
    .number()
    .int()
    .positive()
    .max(4320)
    .optional()
    .describe("Composition height in pixels. Default 1080."),
})

const submitHtmlCompositionBlockedSchema = z.object({
  status: z
    .literal("blocked")
    .describe("Cannot produce a composition for this request."),
  message: z
    .string()
    .min(1)
    .max(500)
    .describe("Concise reason you cannot proceed."),
})
...
export type SubmitHtmlCompositionDoneInput = z.infer<
  typeof submitHtmlCompositionDoneSchema
>
export type SubmitHtmlCompositionInput = z.infer<
  typeof submitHtmlCompositionSchema
>
