...
export const proseNodeSchema: z.ZodType<ProseNode> = z.lazy(() =>
  z.object({
    ...
    content: z
      .array(z.union([proseTextNodeSchema, proseNodeSchema]))
      .optional(),
    text: z.string().optional(),
  }),
)
...
export const updateFilePositionRequestSchema = z
  .object({
    id: z.string(),
    anchorId: z.string().nullable().optional(),
...
export const updateFileContentRequestSchema = z
  .object({
...
export const updateTextFileContentRequestSchema = z
  .object({
    content: z.string().optional(),
...
export type UpdateFilePositionRequest = z.infer<
  typeof updateFilePositionRequestSchema
>
...
>
export type UpdateTextFileContentRequest = z.infer<
  typeof updateTextFileContentRequestSchema
>
export type FileCreationRequest = z.infer<typeof fileCreationRequestSchema>
export type FileNodeInsertPosition = z.infer<
  typeof fileNodeInsertPositionSchema
>
