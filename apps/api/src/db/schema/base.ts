...
export type ModelAndParameterOption =
  typeof modelsAndParameterOptions.$inferSelect
...
export type BillingReservationStatus =
  (typeof billingReservationStatusEnum.enumValues)[number]
export type BillingLedgerKind =
  (typeof billingLedgerKindEnum.enumValues)[number]
...
export type VideoRenderJobStatus =
  (typeof videoRenderJobStatusEnum.enumValues)[number]
