...
const settings: Array<SettingConfig> = [
  {
    label: "Genre",
    storeKey: "genre",
  ...
  },
  {
    label: "Tone",
    storeKey: "tone",
    component: SelectTone,
    icon: IconMoodSmile,
  },
  {
    label: "Target Audience",
    storeKey: "targetAudience",
    component: SelectAudience,
    icon: IconUsers,
  },
  {
    label: "Primary Platform",
    storeKey: "primaryPlatform",
    component: SelectPlatform,
    icon: IconBrandYoutube,
  },
  {
    label: "Outline Structure",
    storeKey: "outlineStructure",
    component: OutlineStructure,
    icon: IconListTree,
  },
  {
    label: "Narrative Style",
    storeKey: "narrativeStyle",
    component: NarrativeStyle,
    icon: IconBook,
  },
  {
    label: "Video Aspect Ratio",
    storeKey: "videoAspectRatio",
    component: VideoAspectRatio,
    icon: IconAspectRatio,
  },
  {
    label: "Character Style",
    storeKey: "characterStyle",
...
export default function NewProjectSettings() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="sm:max-w-6xl h-[80%] max-h-[800px] bg-gray-800 p-0 rounded-xl"
      ...
      >
        ...
        <div className="flex gap-4 h-full min-h-0">
          <div className="flex flex-col gap-2 bg-white/10 p-4 rounded-l-xl overflow-y-auto overscroll-y-none">
            ...
            <div className="space-y-4">
              {settings.map((setting) => (
                <div
                  key={setting.label}
                  className="flex items-center gap-2 w-full px-4 py-2 hover:bg-gray-200/10 rounded-lg cursor-pointer"
          ...
          <div className="flex-1 min-h-0 overflow-y-auto p-4">
            <div className="space-y-4">
              <content.component
                onSelect={handleSelect(content.label)}
      ...
      <div className="grid grid-cols-4 gap-4">
        {options.map((opt) => (
          <SettingItem
            ...
            value={opt.value}
            onClick={handleClick}
            isSelected={opt.value === selectedValue?.value}
          />
        ))}
      </div>
    </div>
...
function SettingItem({
  ...
  return (
    <button
      className="cursor-pointer duration-300 space-y-2 group"
