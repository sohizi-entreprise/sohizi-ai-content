    ...
    <div className="flex flex-col gap-8 pt-8 font-space-grotesk">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Your journey starts here. Manage &amp; start new adventures.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex bg-white/5 p-1 rounded-xl border border-white/10 relative">
            <button
              className={cn(
                "px-3 py-1.5 rounded-lg text-slate-500 text-xs font-bold",
                { "text-primary": searchQuery.display === "grid" },
              )}
            ...
            <button
              className={cn(
                "px-3 py-1.5 rounded-lg text-slate-500 text-xs font-bold",
                { "text-primary": searchQuery.display === "list" },
              )}
            ...
            <div
              className={cn(
                "absolute bottom-[2px] left-px w-1/2 h-[calc(100%-4px)] bg-primary/20 rounded-xl transition-all duration-300",
                {
                  "translate-x-px": searchQuery.display === "grid",
                  "translate-x-[calc(100%-2px)]":
                    searchQuery.display === "list",
                },
              )}
            />
          </div>
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 p-2 rounded-2xl flex flex-col md:flex-row gap-4 items-center">
        <div className="relative flex-1 w-full">
          ...
          <input
            className="w-full bg-white/5 border-none rounded-xl pl-12 pr-4 py-3 text-sm text-white placeholder-slate-500 focus:ring-1 focus:ring-primary/40 transition-all"
            placeholder="Query projects by title, character, or plot point..."
            type="text"
          />
        </div>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 no-scrollbar">
          ...
          <button className="px-3 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-xs font-medium whitespace-nowrap">
            All
          </button>
          <button className="px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-slate-400 text-xs font-medium hover:border-white/30 whitespace-nowrap">
            Sci-Fi
          </button>
          <button className="px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-slate-400 text-xs font-medium hover:border-white/30 whitespace-nowrap">
            Noir
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex space-x-1">
            <button className="w-8 h-8 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center text-blue-400 group relative">
              ...
              <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-black text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                Drafting
              </div>
            </button>
